...
const MAX_NUM_STEPS: i32 = 32;
const EPSILON: f32 = 0.0001;
const MAX_TRACE_DISTANCE: f32 = 100.;
...
impl Camera {
    ...
    pub fn render(&self, geometry: &Geom) -> Image {
    ...
    fn ray_march(&self, direction: &Vec3, geometry: &Geom) -> Color {
    ...
    fn compute_normal(&self, position: &Vec3, geometry: &Geom) -> Vec3 {
